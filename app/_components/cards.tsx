...
export default function Cards({ Profile, ExamName, Color, img }: CardsProps) {
  return (
    <Link
      ...
      className="mt-8 w-64 h-[330px] flex flex-col justify-center cursor-pointer items-center rounded-3xl transform transition-transform duration-200 hover:scale-105 hover:shadow-lg"
      style={{ backgroundColor: Color }}
    >
      <Image src={img} alt="eng" height={100} width={100} />
      <div className="text-3xl mt-6 font-Poppins font-extrabold text-black mb-0 text-center">
        {Profile}
      </div>
